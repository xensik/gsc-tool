...
struct token
{
    enum kind : u8
    {
        PLUS, MINUS, STAR, DIV, MOD, BITOR, BITAND, BITEXOR, SHL, SHR, ARROW, SEQ, SNE,
        ...
        DEVBEGIN, DEVEND, INLINE, INCLUDE, INSERT, USING, USINGTREE, NAMESPACE, ANIMTREE, FUNCTION, AUTOEXEC,
        CODECALL, PRIVATE, ENDON, NOTIFY, WAIT, WAITREALTIME, WAITTILL, WAITTILLMATCH, WAITTILLFRAMEEND,
        IF, ELSE, DO, WHILE, FOR, FOREACH, IN, SWITCH, CASE, DEFAULT, BREAK, CONTINUE, RETURN, PROFBEGIN,
        PROFEND, THREAD, TRUE, FALSE, UNDEFINED, SIZE, GAME, SELF, ANIM, LEVEL, WORLD, CLASSES, NEW,
