...
public:
    ...
    auto func_id_v2(std::string const& name) const -> u64;
    auto func_name_v2(u64 id) const -> std::string;
    ...
    auto meth_id_v2(std::string const& name) const -> u64;
    auto meth_name_v2(u64 id) const -> std::string;
...
protected:
    ...
    std::unordered_map<u64, std::string_view> func_map_v2_;
    std::unordered_map<u64, std::string_view> meth_map_v2_;
