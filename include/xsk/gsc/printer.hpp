...
private:
    ...
    auto print_decl_constant(decl_constant const& dec) -> void;
    ...
    auto print_stmt_waitframe(stmt_waitframe const& stm) -> void;
    ...
    auto print_stmt_assert(stmt_assert const& stm) -> void;
    auto print_stmt_assertex(stmt_assertex const& stm) -> void;
    auto print_stmt_assertmsg(stmt_assertmsg const& stm) -> void;
    auto print_stmt_create(stmt_create const& stm) -> void;
    auto print_stmt_remove(stmt_remove const& stm) -> void;
    auto print_stmt_clear(stmt_clear const& stm) -> void;
    ...
    auto print_expr_add_array(expr_add_array const& exp) -> void;
    ...
    auto print_expr_istrue(expr_istrue const& exp) -> void;
    auto print_expr_reference(expr_reference const& exp) -> void;
    auto print_expr_tuple(expr_tuple const& exp) -> void;
    ...
    auto print_expr_thisthread(expr_thisthread const& exp) -> void;
    ...
    auto print_expr_var_create(expr_var_create const& exp) -> void;
    auto print_expr_var_access(expr_var_access const& exp) -> void;
};
