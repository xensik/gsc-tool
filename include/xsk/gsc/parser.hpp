...
private:
    ...
    auto parse_decl_constant() -> decl::ptr;
    ...
    auto parse_stmt_waitframe() -> stmt::ptr;
    ...
    auto parse_stmt_breakpoint() -> stmt::ptr;
    auto parse_stmt_prof_begin() -> stmt::ptr;
    auto parse_stmt_prof_end() -> stmt::ptr;
    auto parse_stmt_assert() -> stmt::ptr;
    auto parse_stmt_assertex() -> stmt::ptr;
    auto parse_stmt_assertmsg() -> stmt::ptr;
