...
std::unordered_map<std::uint16_t, std::string> resolver::builtin_function_map
{
	...
	{ 0x32, "SetDvar" },
	{ 0x33, "SetDynamicDvar" },
	{ 0x34, "SetDvarIfUninitialized" },
	{ 0x35, "SetDvar" },
	{ 0x36, "SetDvarIfUninitialized" },
	{ 0x37, "GetDvar" },
	{ 0x38, "GetDvarInt" },
	{ 0x39, "GetDvarFloat" },
	{ 0x3A, "GetDvarVector" },
	...
	{ 0x3C, "GetEntByNum" },
	{ 0x3D, "GetWeaponModel" },
	{ 0x59, "GetWeaponDisplayName" },
	{ 0x5A, "GetWeaponBaseName" },
	{ 0x5B, "GetWeaponAttachments" },
	{ 0x5C, "GetWeaponAttachmentDisplayNames" },
	{ 0x5D, "GetWeaponCamoName" },
	{ 0x5E, "GetWeaponReticleName" },
	{ 0x5F, "GetWeaponHideTags" },
	{ 0x60, "GetAnimLength" },
	{ 0x61, "AnimHasNotetrack" },
	{ 0x62, "GetNotetrackTimes" },
	{ 0x63, "Spawn" },
	{ 0x64, "Spawn" },
	{ 0x65, "SetPathnodeField" },
	{ 0x66, "BulletTrace" },
	{ 0x82, "BulletTracePassed" },
	{ 0x83, "SightTracePassed" },
	{ 0x84, "PhysicsTrace" },
	{ 0x85, "PlayerPhysicsTrace" },
	{ 0x86, "GetGroundPosition" },
	{ 0x87, "GetMoveDelta" },
	{ 0x88, "GetAngleDelta" },
	...
	{ 0xDD, "AngleClamp360" },
	{ 0xDE, "AngleClamp180" },
	{ 0xDF, "VectorFromLineToPoint" },
	{ 0xE0, "PointOnSegmentNearestToPoint" },
	{ 0x21A, "IsPointInVolume" },
	{ 0xE1, "Distance" },
	{ 0xE2, "Distance2D" },
	{ 0x210, "Distance2DSquared" },
	{ 0xE3, "DistanceSquared" },
	{ 0xE4, "Length" },
	{ 0xE5, "Length2D" },
	{ 0xE6, "LengthSquared" },
	{ 0xE7, "Length2DSquared" },
	{ 0xE8, "Closer" },
	{ 0xE9, "VectorDot" },
	{ 0xEA, "VectorCross" },
	...
	{ 0x1F, "BadPlace_Delete" },
	{ 0x20, "BadPlace_Cylinder" },
	{ 0x21, "BadPlace_Arc" },
	{ 0x22, "BadPlace_Brush" },
	{ 0x1FD, "BadPlace_Global" },
	{ 0xBC, "GetClosestNodeInSight" },
	...
	{ 0xCF, "Current" },
	{ 0x7B, "OnEntity" },
	{ 0x7C, "OnEntityWithRotation" },
	{ 0x7D, "Team" },
	{ 0x7E, "Player" },
	{ 0x7F, "PlayerTeam" },
	{ 0x80, "PlayerEnemyTeam" },
	{ 0x81, "PlayerMask_HideFromAll" },
	{ 0x82, "PlayerMask_HideFrom" },
	{ 0x83, "PlayerMask_ShowToAll" },
	{ 0x84, "PlayerMask_ShowTo" },

	// ------------------------------------------------------------------------
	//FUNCTION SENTIENT 7
	{ 0xFA, "CreateThreatBiasGroup" },
	{ 0xFB, "ThreatBiasGroupExists" },
	{ 0xFC, "GetThreatBias" },
	{ 0xFD, "SetThreatBias" },
	{ 0xFE, "SetThreatBiasAgainstAll" },
	{ 0xFF, "SetIgnoreMeGroup" },
	{ 0x100, "IsEnemyTeam" },
