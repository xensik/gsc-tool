...
private:
	...
	void decompile_loop(const gsc::block_ptr& block, std::uint32_t begin, std::uint32_t end);
	void decompile_while(const gsc::block_ptr& block, std::uint32_t begin, std::uint32_t end);
