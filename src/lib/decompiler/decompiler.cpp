...
void decompiler::decompile_statements(std::shared_ptr<decompiler_function> func)
{
	for (auto inst : func->instructions)
	{
		...
		{
			// TODO
			//XSK_ERROR("missing handler 'OP_RemoveLocalVariables'!");
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_AddArray'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_ScriptLocalChildThreadCall'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_ScriptLocalMethodChildThreadCall'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_ScriptFarChildThreadCall'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_ScriptFarMethodChildThreadCall'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_ScriptMethodChildThreadCallPointer'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_GetAnimObject'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_GetThisthread'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_GetAnim'!");
		}
		break;
		case opcode::OP_GetAnimation:
		{
			// TODO
			XSK_ERROR("missing handler 'OP_GetAnimation'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_waittillmatch2'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_shift_left'!");
		}
		break;
		case opcode::OP_shift_right:
		{
			// TODO
			XSK_ERROR("missing handler 'OP_shift_right'!");
		}
		break;
		case opcode::OP_plus:
		{
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_SafeSetVariableFieldCached0'!");
		}
		break;
		case opcode::OP_SafeSetVariableFieldCached:
		{
			// TODO
			XSK_ERROR("missing handler 'OP_SafeSetVariableFieldCached'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_GetAnimTree'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_EvalNewLocalVariableRefCached0'!");
		}
		break;
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_ClearVariableField'!");
		}
		break;
		case opcode::OP_SetAnimFieldVariableField:
		{
			// TODO
			XSK_ERROR("missing handler 'OP_SetAnimFieldVariableField'!");
		}
		break;
		...
		{
			// TODO
			// XSK_ERROR("missing handler 'OP_ClearLocalVariableFieldCached'!");
		...
		{
			// TODO
			// XSK_ERROR("missing handler 'OP_ClearLocalVariableFieldCached0'!");
		...
		{
			// TODO
			//XSK_ERROR("missing handler 'OP_CastFieldObject'!");
		...
		{
			// TODO
			XSK_ERROR("missing handler 'OP_BoolComplement'!");
		}
		break;
		default:
		{
