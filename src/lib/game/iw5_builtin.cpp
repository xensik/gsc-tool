...
auto get_builtin_func_id(const std::string& name) -> std::uint16_t
{
	...
	XSK_ERROR("Couldn't resolve builtin function id for name '%s'!", name.c_str());
	return 0xFFFF;
}
...
auto get_builtin_func_name(std::uint16_t id) -> std::string
{
	...
	XSK_ERROR("Couldn't resolve builtin function name for id '%i'!", id);
	return "";
}
...
auto get_builtin_method_id(const std::string& name) -> std::uint16_t
{
	...
	XSK_ERROR("Couldn't resolve builtin method id for name '%s'!", name.c_str());
	return 0xFFFF;
}
...
auto get_builtin_method_name(std::uint16_t id) -> std::string
{
	...
	XSK_ERROR("Couldn't resolve builtin method name for id '%i'!", id);
	return "";
}
