...
context::context(gsc::instance inst) : gsc::context(feature::str4 | feature::waitframe | feature::boolnotand | feature::offs8,
    engine::s2, endian::little, system::pc, inst, max_string_id)
{
