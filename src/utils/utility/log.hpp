...
#ifdef DEBUG
#define LOG_DEBUG(__FMT__, ...) printf("[D][" __FUNCTION__ "]: " __FMT__ "\n", __VA_ARGS__)
#define LOG_ERROR(__FMT__, ...) printf("[E][" __FUNCTION__ "]: " __FMT__ "\n", __VA_ARGS__)
#define LOG_WARN(__FMT__, ...)  printf("[W][" __FUNCTION__ "]: " __FMT__ "\n", __VA_ARGS__)
