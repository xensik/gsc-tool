...
{{
    ...
    { 0x51DB321F, "add_afterlife" },
    { 0x1412EE9C, "adsZeroSpread" },
    { 0x5F9CD874, "aiForceThrowDownWeapon" },
    { 0xD2DF7981, "aiQuadrantSwitch" },
    ...
    { 0x5CBE6F6A, "ai_debugAiming" },
    { 0x1DF154F7, "ai_debugAnimDeltas" },
    { 0x40CDA2CF, "ai_debugAnimscript" },
    { 0xFFC390BD, "ai_debugClaimedNodes" },
    { 0x1A89574D, "ai_debugColorNodes" },
    { 0x3F886B38, "ai_debugCoverArrivals" },
    { 0x57FCCA16, "ai_debugCoverArrivalsTool" },
    { 0x876D873E, "ai_debugCoverArrivalsToolRadius" },
    { 0x8FA91890, "ai_debugCoverArrivalsToolShowNodes" },
    { 0x3F219298, "ai_debugCoverArrivalsToolType" },
    ...
    { 0x76D4E0FF, "ai_debugLookAt" },
    { 0x7E794ED3, "ai_debugMayMove" },
    { 0xE9FDD26E, "ai_debugMeleeAttackSpots" },
    { 0xDB939FA2, "ai_debugNodeoffset" },
    { 0x83D71FD9, "ai_debugRappel" },
    { 0xD0470A59, "ai_debugSpawnManager" },
    { 0xB142FD65, "ai_debugStartAimNotetrack" },
    { 0xE5058323, "ai_debugThreatSelection" },
    { 0x04DECC24, "ai_debugTrackingTurns" },
    { 0x32B996B1, "ai_debugTurns" },
    { 0x0C5E1FC8, "ai_degbugBigdog" },
    { 0xDD8D070B, "ai_disableSpawn" },
    { 0xF36C4D76, "ai_enableMoveLookAt" },
    ...
    { 0xDE8EB56D, "ai_forceBehavior" },
    { 0x028FFFAC, "ai_forceCheatAmmo" },
    { 0x140B3667, "ai_forceCornerDirection" },
    { 0x4A3A380B, "ai_forceCornerMode" },
    { 0x4151075A, "ai_force_stance" },
    { 0x1063EFAA, "ai_force_suppressed" },
    ...
    { 0xC0693041, "ai_monitorNeedsKeys" },
    ...
    { 0x94D73B5A, "ai_quadrantAnimDebug" },
    { 0x7927E91F, "ai_rambo" },
    ...
    { 0xE87B44C5, "aim_assist_min_target_distance" },
    { 0x951514DE, "aim_turnrate_pitch_ads" },
    { 0x25A65277, "aim_turnrate_yaw_ads" },
    { 0x81DDB107, "airburstAdjustDistance" },
    { 0x9624FC9B, "alcatraz_final_battle" },
    { 0xDF65AA39, "alcatraz_give_shield" },
    ...
    { 0xF224451F, "angles" },
    { 0x5DF80895, "anim_intro" },
    { 0x55B6AAF4, "animated_trees_enabled" },
    { 0xF273BD1C, "artist" },
    { 0x7F6F03E6, "attachment_exclusion_" },
    { 0x373B6254, "autocraft_staffs" },
    { 0xAF0D5C36, "award_challenge" },
    ...
    { 0x72BFD45D, "bg_bobAmplitudeStanding" },
    ...
    { 0x87148D93, "briggs_alive" },
    { 0x8DB11170, "brutus_debug" },
    { 0x19B966D7, "buildType" },
    { 0x3C0D12E4, "build_plane" },
    { 0x7D075455, "build_quadrotor" },
    ...
    { 0x0EC60F96, "cg_aggressiveCullRadius" },
    ...
    { 0x5AEFD7E9, "cg_cameraUseTagCamera" },
    ...
    { 0xD96CB2B0, "cg_objectiveIndicatorNearFadeDist" },
    ...
    { 0x763A3046, "chamber_wall" },
    { 0x39165C89, "chaplincheat" },
    { 0x1186DB2D, "cheat_sq" },
    { 0x014A13E8, "checkEmblemForRank" },
    { 0x95EB46BE, "cinCaptureEnabled" },
    ...
    { 0xD90ED392, "cmd_send_chopper" },
    { 0x4D60CDD2, "cmd_skipto" },
    { 0x171ED264, "cmd_take_poi" },
    ...
    { 0xBB20372B, "complete_puzzles1" },
    { 0xBB20372C, "complete_puzzles2" },
    ...
    { 0x274F266C, "createfx_playerpos_x" },
    { 0x274F266D, "createfx_playerpos_y" },
    { 0x274F266E, "createfx_playerpos_z" },
    { 0x5A7DE640, "createfx_print_frames" },
    { 0xD0C4376B, "createfx_scaleid" },
    { 0xF75FC86A, "creditsScrollScale" },
    { 0xDA8CD87B, "currentDifficulty" },
    { 0x7547FDB7, "currentTUVersion" },
    { 0x4083079F, "customGameMode" },
    { 0xE1D3321F, "custom_" },
    { 0x8F4AAEF4, "custom_killstreak_" },
    ...
    { 0x826EB3B9, "custom_killstreak_mode" },
    { 0x2F851AB2, "custom_perks_allow_pro" },
    { 0x3B52EA17, "dds_debugActiveEvents" },
    { 0x0F49A52C, "debug" },
    { 0xD7997EA3, "debugRenderCollisionDistance" },
    { 0x7706D878, "debugRenderMask" },
    { 0x0AEB127D, "debug_audio" },
    { 0x0E130E60, "debug_character_count" },
    { 0xC450CB50, "debug_color_pallete" },
    { 0x38E629E6, "debug_dds" },
    { 0x0B188A91, "debug_death" },
    { 0x29D6BB09, "debug_deathBodyFallNotetrack" },
    { 0xA2C6B0AB, "debug_deathents" },
    { 0x0B18CA60, "debug_depth" },
    { 0x6EBEB982, "debug_dog_notetracks" },
    { 0x7B06BF0D, "debug_dog_sound" },
    { 0xB7E2EEBA, "debug_draw_event" },
    { 0x36FAE5DF, "debug_dynamic_ai_spawning" },
    { 0x99BAF398, "debug_engage_dists" },
    { 0x02C7E46E, "debug_friendlyfire" },
    { 0x113D4769, "debug_fx" },
    { 0x55AD9BED, "debug_heli" },
    { 0xD8E6D53A, "debug_helicopter" },
    { 0x55ADE0CE, "debug_hurt" },
    { 0x55AEF8E7, "debug_jump" },
    { 0xC394DFE1, "debug_killstreak" },
    { 0xD77F221A, "debug_light_mixers" },
    { 0x55B04A98, "debug_maze" },
    { 0x4C406056, "debug_misstime" },
    { 0x0BC4784C, "debug_music" },
    { 0x2D9DA875, "debug_noanimscripts" },
    { 0x55B12A1E, "debug_nuke" },
    { 0xBC8CA09D, "debug_protocol" },
    { 0x8EAE5CA0, "debug_rcbomb" },
    { 0x628768B6, "debug_reflection" },
    { 0x33E24970, "debug_reflection_matte" },
    { 0x1BE0BEF8, "debug_show_viewpos" },
    { 0x91982525, "debug_skipto" },
    { 0x113D490F, "debug_sq" },
    { 0x0C303399, "debug_start" },
    { 0x49A098B5, "debug_surface_type" },
    { 0x55B41FB9, "debug_tank" },
    { 0x94A738D1, "debug_turret" },
    { 0xD256F24B, "debug_unitrigger" },
    { 0x999365E0, "debug_vehicle_health" },
    { 0x6A0F794A, "debug_vehicle_paths" },
    { 0x30187699, "debug_vehicle_turret_ai" },
    { 0x95A4535C, "debug_vehicleresume" },
    { 0x7E7B1968, "debug_vehiclesetspeed" },
    { 0x1AD074DA, "debug_zone_capture" },
    ...
    { 0x2A7D534B, "demoname" },
    { 0xCA911A0F, "depth_close" },
    { 0x6C527472, "depth_far" },
    ...
    { 0x2685E710, "dg_sq_map" },
    { 0xDAD9AAFF, "dg_sq_player" },
    ...
    { 0x6F30FD20, "ee_main_end_level" },
    { 0xA6E41BC7, "ee_main_progress" },
    { 0x6E33C5DD, "ee_upgrade_beacon" },
    ...
    { 0x13510208, "fa38_disable_hud_damage" },
    { 0xA0FE0B5C, "factoryAftereffectOverride" },
    { 0xC7029A24, "failure_disabled" },
    { 0xCC860215, "fallback" },
    { 0x5337BF3B, "farid_alive" },
    { 0x33495B58, "fbEnabled" },
    { 0xC2DCBC26, "fire_audio_random_max_duration" },
    { 0x917E4521, "fire_audio_repeat_duration" },
    ...
    { 0x40772CF1, "force_char" },
    { 0x4077D7E0, "force_dogs" },
    { 0x79D9A3FA, "force_giant_robot_0" },
    { 0x79D9A3FB, "force_giant_robot_1" },
    { 0x79D9A3FC, "force_giant_robot_2" },
    { 0xD816D475, "force_left_foot" },
    { 0x462243C8, "force_right_foot" },
    { 0xDF4E4957, "force_three_robot_round" },
    { 0x6A497752, "force_weather_none" },
    { 0x6A4B6CAC, "force_weather_rain" },
    { 0x6A4C3129, "force_weather_snow" },
    { 0xE18BB6E3, "friction" },
    { 0xBF60299F, "friendlySaveFromDog" },
    ...
    { 0x06BF71E8, "g_banIPs" },
    { 0xBCB625CF, "g_banzai_player_fov_buffer" },
    ...
    { 0xB1E41F18, "get_master_key" },
    { 0xCBE49262, "geyser_time" },
    { 0x1EBA666E, "geyser_tweak_push" },
    { 0x0B8472AB, "geyser_x" },
    { 0x0B8472AC, "geyser_y" },
    { 0x0B8472AD, "geyser_z" },
    { 0x13DE4CFD, "gib_debug" },
    { 0x13DE7505, "gib_delay" },
    { 0x0864DA16, "gib_test" },
    { 0x817E2753, "give_craftable" },
    { 0x8B880FB8, "give_golden_shovel" },
    { 0xAE371CCE, "give_helmet" },
    { 0xC817F0A0, "give_shovel" },
    { 0xF4EDB01C, "goodPing" },
    ...
    { 0x21D60E03, "helisounds" },
    { 0x0F943F25, "hiDef" },
    { 0xC6C655D4, "highlightedPlayerName" },
    { 0xD5C71324, "hudElemPausedBrightness" },
    { 0x5193604C, "hud_missionFailed" },
    { 0x1F233594, "hud_showObjectives" },
    { 0x723A8A44, "hud_showStance" },
    ...
    { 0x5BC716E4, "in_mouse" },
    { 0xCCAFCC91, "introscreen" },
    { 0x7A726C79, "inviteText" },
    { 0x1F48DCEB, "invite_waitPeriod" },
    { 0x32DF55CC, "item_exclusion_" },
    { 0x595BC324, "jetsounds" },
    { 0xA1221834, "jolie_greet_debug" },
    { 0x1C30AA9C, "jolie_greet_time" },
    { 0x7D3E7879, "jump_height" },
    { 0x55EDBF33, "jump_ladderPushVel" },
    { 0x4E3BC729, "jump_pad_forward" },
    { 0xD5FD01C3, "jump_pad_tweaks" },
    { 0xE2494021, "jump_pad_z_dist" },
    { 0xF5012724, "jump_slowdownEnable" },
    { 0x7656DC68, "jump_spreadAdd" },
    { 0x67905337, "jump_stepSize" },
    { 0xB81FE6C1, "karma_alive" },
    { 0x99DBAF6D, "killOnlyTrailFX" },
    { 0xB5F23DCA, "la_1_ending_position" },
    { 0xCEC8DDF8, "la_F35_pilot_saved" },
    { 0xE0C8EA9C, "la_G20_1_saved" },
    { 0x2DC3275D, "la_G20_2_saved" },
    { 0x90CEA541, "la_harperdead" },
    { 0x5EB50757, "la_harperscarred" },
    ...
    { 0x85A1539B, "level_clear_all" },
    { 0x3C98BCAE, "level_completeall" },
    { 0xB42CFE95, "level_notify" },
    { 0x2E717886, "level_transition_test" },
    ...
    { 0x5C1C5F18, "max_zombie_escapees" },
    { 0xD3DD6600, "maxreservedslots" },
    { 0x6DCD047E, "mechz_behavior_dist" },
    { 0x2F660A7B, "mechz_behavior_orient" },
    { 0xE7121222, "mechz_debug" },
    { 0x7D9211F9, "mechz_force_behavior" },
    ...
    { 0x29B5091E, "minecart_debug" },
    { 0xF95FF250, "miniscoreboardhide" },
    { 0xEB5692B2, "mis_cheat" },
    { 0x64296AD0, "missileDebugDraw" },
    ...
    { 0x0B9BB4E2, "nextmap" },
    { 0x204C4196, "nicaragua_debug" },
    { 0x2BD6864B, "nightVisionDisableEffects" },
    { 0xFC98B985, "nightVisionFadeInOutTime" },
    { 0x44BAA890, "nightVisionPowerOnTime" },
    { 0x5BDF0C62, "noBlindAim" },
    { 0x7C9B464C, "noai" },
    { 0x10873CCA, "noclip" },
    { 0x762F1309, "notarget" },
    { 0xE37C3873, "objectiveIndicatorNoDrawDistance" },
    { 0x4A195B44, "onlinegame" },
    { 0xB7590487, "open_all_teleporters" },
    { 0x63436BFB, "open_chambers" },
    { 0xE0FA89C9, "osc_access_time" },
    ...
    { 0x680FBFB7, "player_damageMultiplier" },
    { 0x4E44E32D, "player_deathInvulnerableTime" },
    { 0x60DDBAAE, "player_debugHealth" },
    { 0x7B56CC18, "player_debugSprint" },
    { 0xB93E75EC, "player_died_recently" },
    ...
    { 0x3F8A7E7C, "req_player_by_point" },
    { 0x772BCD39, "reset_mechz_thinking" },
    { 0xDE68EE01, "restore_gump_name" },
    { 0x19519796, "revive_time_taken" },
    { 0xA17166B0, "revive_trigger_radius" },
    ...
    { 0x4F33EB6C, "rocket_test" },
    { 0xC5165E47, "run_scene" },
    { 0xDD7F5246, "safeArea_horizontal" },
    { 0x149CE636, "safeArea_vertical" },
    { 0x273EAFA7, "sam_intro_skip" },
    ...
    { 0x8178CABA, "scr_RecaptureTargetZone" },
    { 0x33CF364A, "scr_RequiredMapAspectratio" },
    { 0xEF89C4FC, "scr_ZoneCaptureTest" },
    { 0xDA8BDE9E, "scr_ai_auto_fire_rate" },
    ...
    { 0xFD22913A, "scr_autosave_debug" },
    { 0x5628DC9F, "scr_avogadro_bus_window" },
    { 0x92514885, "scr_avogadro_debug" },
    { 0xA40002E9, "scr_avogadro_disable_attack" },
    { 0xCFB33742, "scr_avogadro_disable_phase" },
    { 0xCFA4158E, "scr_avogadro_ignore_power" },
    { 0xFD251E42, "scr_avogadro_region" },
    { 0x72E5D681, "scr_axis" },
    { 0x959D90CA, "scr_bomb_explode_delay" },
    { 0x487CD523, "scr_bot_follow" },
    { 0x1CBC4852, "scr_bot_overlay" },
    { 0xD6F2CC5D, "scr_bot_path" },
    { 0x68A98D18, "scr_bot_threat" },
    ...
    { 0x9E8F8CB7, "scr_copter_damage" },
    { 0xA8262D2E, "scr_copter_health" },
    { 0xC84E4F62, "scr_cornerforcestance" },
    { 0xBB6E7E9C, "scr_coverLookAtDebug" },
    { 0x3380B629, "scr_cqbdebug" },
    ...
    { 0x0A1C40B1, "scr_damage_debug" },
    { 0xC50FF950, "scr_damagefeedback" },
    { 0x8F38FFB9, "scr_deathDebug" },
    { 0x817739B8, "scr_debugAiReactFeature" },
    { 0x6136A815, "scr_debugSlipgun" },
    { 0x61A711C2, "scr_debugSlowgun" },
    { 0x738F6688, "scr_debugStealth" },
    { 0x53BD7080, "scr_debug_hacker" },
    { 0x5D1BFE4D, "scr_debug_launch" },
    ...
    { 0x853C5E58, "scr_debug_ss" },
    { 0x88718E17, "scr_debugfailedcover" },
    { 0x2CCCDCB5, "scr_debugheli" },
    { 0xC6C2EDBB, "scr_debugmelee" },
    { 0x57298A77, "scr_debugtakecover" },
    { 0x8E9CA497, "scr_deleteexplosivesonspawn" },
    { 0xC0DBB722, "scr_devHeliPathsDebugDraw" },
    { 0xB575F615, "scr_devStrafeRunBulletsDebugDraw" },
    { 0x9191CAAA, "scr_devStrafeRunKillcamsDebugDraw" },
    ...
    { 0xE6D8B517, "scr_disable_cac_2" },
    { 0x5661F47E, "scr_disable_weapondrop" },
    { 0xCF6EEB8B, "scr_disableunifiedspawning" },
    ...
    { 0x3B5BF640, "scr_forceAiReactFeature" },
    { 0xB0E130B4, "scr_forceCrawl" },
    { 0x221EA912, "scr_forceExtendedDeath" },
    { 0x28C1D720, "scr_forceSideArm" },
    { 0xA4260542, "scr_forceSpecialDeath" },
    { 0x961D051F, "scr_force_eclipse" },
    { 0x9003F201, "scr_force_finalkillcam" },
    { 0xB097C64C, "scr_force_perk" },
    { 0x3A1C4B42, "scr_force_quantum_bomb_result" },
    { 0x471F9AB9, "scr_force_reticle_index" },
    { 0xA0259FFF, "scr_force_roundkillcam" },
    { 0x45ED7744, "scr_force_weapon" },
    { 0xB107A31D, "scr_forceevent" },
    { 0xA21C71D1, "scr_forcegrenade" },
    { 0xD94F9C11, "scr_forcegrenadecower" },
    { 0xC1849218, "scr_forcekillcam" },
    { 0x760BFF29, "scr_forcelaststand" },
    { 0x5A4675BD, "scr_forcerankedmatch" },
    { 0x273C0FA3, "scr_forceshotgun" },
    { 0xAE3F04F6, "scr_fountain_debug" },
    { 0x4C560F97, "scr_freelock" },
    { 0x89118F97, "scr_freezegun_cylinder_radius" },
    { 0x6FC601E2, "scr_freezegun_cylinder_radius_upgraded" },
    { 0xAD7AE67D, "scr_freezegun_debug" },
    { 0x37695030, "scr_freezegun_inner_damage" },
    { 0x87267E9B, "scr_freezegun_inner_damage_upgraded" },
    { 0x6F465E7E, "scr_freezegun_inner_range" },
    { 0xB6CB84A9, "scr_freezegun_inner_range_upgraded" },
    { 0x1AE5DC03, "scr_freezegun_outer_damage" },
    { 0x27A507CE, "scr_freezegun_outer_damage_upgraded" },
    { 0x66A73BF1, "scr_freezegun_outer_range" },
    { 0xEA34337C, "scr_freezegun_outer_range_upgraded" },
    { 0x02B404CA, "scr_freezegun_shatter_inner_damage" },
    { 0x82170075, "scr_freezegun_shatter_inner_damage_upgraded" },
    { 0xE630909D, "scr_freezegun_shatter_outer_damage" },
    { 0x229589A8, "scr_freezegun_shatter_outer_damage_upgraded" },
    { 0x33624B1D, "scr_freezegun_shatter_range" },
    { 0x89A11428, "scr_freezegun_shatter_range_upgraded" },
    ...
    { 0xA084BFE8, "scr_grenade_debug" },
    { 0x1C9BEA27, "scr_grenadereturnanim" },
    { 0x6EC13261, "scr_groundBurnTime" },
    { 0x2A181C06, "scr_gunxpscale" },
    { 0x428DE100, "scr_hacker_debug" },
    ...
    { 0x92A3625D, "scr_horse_speed" },
    { 0x1F8C9394, "scr_hostmigrationtest" },
    { 0x1CC516F5, "scr_hydro_water_rush" },
    { 0x71478E3A, "scr_hydro_water_rush_down_time" },
    { 0xEF33F5E5, "scr_hydro_water_rush_speed" },
    { 0x25994707, "scr_hydro_water_rush_up_time" },
    { 0x6ECD5E99, "scr_jetgun_cylinder_radius" },
    { 0xBCDDAAFF, "scr_jetgun_debug" },
    { 0xECC8AEC2, "scr_jetgun_drag_range" },
    { 0x6F74DFC8, "scr_jetgun_gib_damage" },
    { 0xD5D25B16, "scr_jetgun_gib_range" },
    { 0x8562CAD8, "scr_jetgun_grind_range" },
    { 0x7FA8E804, "scr_jetgun_knockdown_damage" },
    { 0xB7484BD2, "scr_jetgun_knockdown_range" },
    { 0x0DF057E0, "scr_kick_mintime" },
    { 0x4257CF5C, "scr_kick_time" },
    { 0x45A06390, "scr_killbots" },
    { 0x1F9534FE, "scr_killbottimer" },
    { 0x1961F5E9, "scr_killcam" },
    { 0x0D34D95D, "scr_killcam_posttime" },
    { 0xC45D9077, "scr_killcam_time" },
    { 0x33660DD8, "scr_killcamplaneoffsetx" },
    { 0x33660DD9, "scr_killcamplaneoffsety" },
    { 0x33660DDA, "scr_killcamplaneoffsetz" },
    { 0x218B2530, "scr_killcamrocketoffsetx" },
    { 0x218B2531, "scr_killcamrocketoffsety" },
    { 0x218B2532, "scr_killcamrocketoffsetz" },
    { 0xE449EBB3, "scr_lbguard_timeout" },
    { 0x5A273E4B, "scr_leaper_debug" },
    { 0x298DD9A4, "scr_leaper_test" },
    { 0x5B4FE0B3, "scr_leaper_trace" },
    { 0xA0F97FC5, "scr_mapsize" },
    { 0xD16D59FD, "scr_max_rank" },
    { 0xC1D7DC29, "scr_microwavegun_debug" },
    { 0x4EBE2CF2, "scr_min_prestige" },
    { 0x41464E83, "scr_minecart_cheat" },
    ...
    { 0x1261CFA6, "scr_moon_digger_speed" },
    { 0x72EC4620, "scr_motd" },
    { 0x3FFA6673, "scr_napalmGroundDamage" },
    { 0xA879D65F, "scr_numLives" },
    { 0x875C8507, "scr_obj" },
    { 0x38F47B13, "scr_oldschool" },
    { 0xFBE667DB, "scr_paindebug" },
    { 0x5ABA6445, "scr_perkdebug" },
    { 0xFCECE67E, "scr_playerInvulTimeScale" },
    ...
    { 0x2A70735C, "scr_quantum_bomb_debug" },
    { 0xED4A338E, "scr_quantum_bomb_weapon_starburst_debug" },
    { 0x2FFAB434, "scr_raise_crystals" },
    { 0x855FF558, "scr_rampagebonusscale" },
    { 0x6032F3B4, "scr_rankXpCap" },
    { 0x08660C30, "scr_rcbomb_car_size" },
    { 0xCDE26736, "scr_rcbomb_fadeOut_delay" },
    { 0x88490433, "scr_rcbomb_fadeOut_timeBlack" },
    { 0xAFCAD5CD, "scr_rcbomb_fadeOut_timeIn" },
    { 0xA925AA4E, "scr_rcbomb_fadeOut_timeOut" },
    { 0xB2F33084, "scr_rcbomb_notimeout" },
    { 0x96EBB72E, "scr_recordspawndata" },
    { 0xF9AB897A, "scr_remote_mortar_lifetime" },
    { 0xBF480CE9, "scr_riotshield_debug" },
    { 0x6C3088CA, "scr_round_end" },
    { 0x3B362771, "scr_round_pause" },
    { 0xC5BAA772, "scr_rts_allpkgs" },
    { 0xB36F6E92, "scr_rts_cameraMode" },
    { 0xBC1F5AA9, "scr_rts_enemyDebug" },
    { 0xC79B9C9A, "scr_rts_enemyDisabled" },
    { 0x109698A9, "scr_rts_enemyReportEnabled" },
    { 0xF5F48599, "scr_rts_no_rts" },
    { 0x498EBD49, "scr_rts_squadDebug" },
    { 0x469616C5, "scr_scorestreaks" },
    { 0x181EB11E, "scr_scorestreaks_maxstacking" },
    { 0x72C3A9C6, "scr_screecher_debug" },
    { 0xB0C0D38F, "scr_screecher_ignore_player" },
    { 0x6A65F83E, "scr_screecher_ignore_score" },
    ...
    { 0x6CB7B561, "scr_showlikelyenemypathdir" },
    ...
    { 0x897C9AB4, "scr_sloth_debug_height" },
    { 0x2443DFBB, "scr_sloth_debug_width" },
    ...
    { 0xAD6C19FE, "scr_spawn_visibility_check_max" },
    { 0xA1755E55, "scr_spawnenemyheli" },
    { 0x23E1517A, "scr_spawnenemyu2" },
    { 0x85E6B1CE, "scr_spawner_location_distance" },
    { 0xBB9101B2, "scr_spawner_location_time" },
    { 0xC25B6B47, "scr_spawngraph" },
    { 0x4058B332, "scr_spawnidcycle" },
    { 0x632110E6, "scr_spawnpointdebug" },
    { 0xCACDB8AA, "scr_spawnpointlospenalty" },
    { 0x0FB71FB7, "scr_spawnpointnewlogic" },
    { 0x6A99E750, "scr_spawnpointprofile" },
    { 0x76B8F046, "scr_spawnpointweaponpenalty" },
    { 0x7CA769A6, "scr_spawnprofile" },
    { 0x292A749F, "scr_spawnsimple" },
    { 0xDFF9F5CE, "scr_straferunlookahead" },
    { 0x6E34324D, "scr_straferunoffset" },
    { 0x74D7F06E, "scr_straferunradius" },
    ...
    { 0xE5069375, "scr_tesla_arc_travel_time" },
    { 0xDF26DD48, "scr_tesla_head_gib_chance" },
    { 0x31F0CB32, "scr_tesla_max_arcs" },
    { 0xC613594F, "scr_tesla_max_enemies" },
    { 0xEFA4DB31, "scr_tesla_radius_decay" },
    { 0xF0BC7E19, "scr_tesla_radius_start" },
    { 0x316B7BEF, "scr_testScriptRuntimeError" },
    { 0x8EF43DBE, "scr_testclients" },
    { 0xC97483EC, "scr_testclientsremove" },
    { 0x70EE00F9, "scr_testdvar" },
    { 0xB1EF0F01, "scr_thief_health_endgame" },
    { 0x6BEEADD6, "scr_thief_health_max" },
    { 0x0A166651, "scr_thief_health_pregame" },
    { 0x6A72EA6A, "scr_thief_speed_damage" },
    { 0xDEA6F730, "scr_thundergun_cylinder_radius" },
    { 0xAAC84AD6, "scr_thundergun_debug" },
    { 0x16044A2B, "scr_thundergun_fling_range" },
    { 0x795FFDFF, "scr_thundergun_gib_damage" },
    { 0xF5270E6D, "scr_thundergun_gib_range" },
    { 0xEAB5937B, "scr_thundergun_knockdown_damage" },
    { 0x2721E469, "scr_thundergun_knockdown_range" },
    ...
    { 0x480B1A1D, "scr_vehicle_healthnumbers" },
    { 0x2070E289, "scr_vehicles_enabled" },
    ...
    { 0xF8D00F60, "scr_xprate" },
    { 0x12E4DD1C, "scr_xpscale" },
    { 0x92FC9AA3, "scr_xpzmscale" },
    { 0xB0FB65D0, "scr_zm_enable_bots" },
    { 0x99BF96D1, "scr_zombie_cleansed_spawns_debug" },
    { 0x3CD25BFE, "scr_zombie_dogs" },
    { 0x5B45DCAF, "scr_zombie_healthbars" },
    { 0x7F11F572, "scr_zombie_melee_dist_debug" },
    { 0xD81B6E19, "scr_zombie_round" },
    { 0xA8C231AA, "scr_zombie_spawn_in_view" },
    ...
    { 0x93087F74, "show_craftable_locations" },
    { 0x6DF184E8, "show_driver_anims" },
    { 0x96F6EBD9, "show_driver_speaking_anims" },
    { 0xA3C6E365, "show_morse_code" },
    ...
    { 0x31D6EE53, "skip_greenlight_build" },
    { 0x1BEC029F, "skipto" },
    ...
    { 0x39C93D95, "snd_set_music_state" },
    ...
    { 0x5E6F2932, "spawn_Brutus" },
    { 0x877D2B64, "spawn_Mechz" },
    { 0x76E825DB, "spawn_all_mounds" },
    { 0xB92412E8, "spawn_max_mounds" },
    ...
    { 0x9D237849, "test_blood_mounds" },
    { 0x6CF3EB40, "test_mechz_robot" },
    { 0x0DE1409A, "test_mechz_sprint" },
    { 0xBD7CA008, "test_mechz_tank" },
    { 0xA3C7E066, "test_oneinchpunch" },
    { 0x0C236601, "test_oneinchpunch_air" },
    { 0x9092E46B, "test_oneinchpunch_fire" },
    { 0x0C238736, "test_oneinchpunch_ice" },
    { 0x09341C49, "test_oneinchpunch_lightning" },
    { 0x8921AB91, "test_oneinchpunch_upgraded" },
    { 0x4806208C, "test_player_tablet" },
    { 0x3608B991, "theaterAftereffectOverride" },
    ...
    { 0xF83E8105, "ui_hud_showdeathicons" },
    ...
    { 0x0F241E06, "ui_singlemission" },
    { 0x1DFA0958, "ui_singlemission_difficulty" },
    { 0x26C61C3F, "ui_skipMainLockout" },
    ...
    { 0x5256118F, "zm_buried_sq_debug" },
    { 0xCD22CF55, "zm_encounters_cheat" },
    { 0xEA6D219A, "zm_instajoin" },
    { 0x6C610250, "zm_novocals" },
    { 0xD446AE4D, "zm_rand_loc" },
    { 0x5D1D04D4, "zm_rand_mode" },
    { 0xFA71C6BA, "zombie_blood" },
    { 0x61FFB6CE, "zombie_bus_debug_attach" },
    { 0x29B9C39F, "zombie_bus_debug_near" },
    { 0x10AC3C99, "zombie_bus_debug_players" },
    { 0x6152C9EA, "zombie_bus_debug_speed" },
    { 0xF7C16264, "zombie_bus_force_to_stay" },
    { 0x69C4D2C1, "zombie_bus_gas_amount" },
    { 0x1CF9CD76, "zombie_bus_wait_time" },
    { 0xFA81816F, "zombie_cheat" },
    { 0xFA91EA91, "zombie_debug" },
    { 0x5B3631D7, "zombie_debug_temple_pap" },
    { 0xCF687B54, "zombie_default_max" },
    { 0xA965F402, "zombie_devgui_attach" },
    { 0xE2245F05, "zombie_devgui_give_ability" },
    { 0xCE4F9F97, "zombie_devgui_gun" },
    { 0x7FEC8C2B, "zombie_devgui_hrelevatorfloor" },
    { 0x8693373F, "zombie_devgui_hrelevatorgo" },
    { 0x7844BB8F, "zombie_devgui_hrelevatorstop" },
    { 0xC0F9913E, "zombie_devgui_hrescapepodreset" },
    { 0x0A84512A, "zombie_devgui_hrpowerlighting" },
    { 0x0726367F, "zombie_devgui_take_ability" },
    { 0x4CD9FAEE, "zombie_devgui" },
    { 0x942939D4, "zombie_dog_animset" },
    { 0x27D7087D, "zombie_double_wide_checks" },
    { 0xFA9CEAA6, "zombie_equipment_attack_freq" },
    { 0xEB512CB7, "zombie_equipment_health" },
    { 0xD0575D76, "zombie_kill_timer" },
    { 0xFB12F109, "zombie_kills" },
    { 0x60AEA36D, "zombie_leapers_disabled" },
    { 0x2222BA21, "zombie_player_vo_overwrite" },
    { 0x4A4203B1, "zombie_reachin_freq" },
    { 0x7688603C, "zombie_rise_test" },
    { 0xB253DFE7, "zombie_shield_attack_freq" },
    { 0x583AF524, "zombie_stop_every_emp_point" },
    { 0x6896A7C3, "zombie_taunt_freq" },
    { 0xFEE4CB69, "zombie_transit_character_force" },
    { 0x2ECA0C0E, "zombie_unlock_all" },
    { 0xDEB90F93, "zombie_useOldPathFallback" },
    { 0xE9322600, "zombie_zone_monitor_disable" },
    { 0x2313B5C5, "zombie_zone_test" },
    { 0x10549CEE, "zombiemode_debug_napalm" },
    { 0x1064B0B1, "zombiemode_debug_sonic" },
    { 0x10E35BC4, "zombiemode_debug_zones" },
    { 0x4DECF257, "zombiemode_path_minz_bias" },
    { 0x6F8A0CF1, "zombies_debug_time_bomb" },
    { 0x38E68F2B, "zombies_debug_vulture_perk" },
    { 0xF75E07AF, "zombies_perk_vulture_ammo_chance" },
    { 0x70E3B3FA, "zombies_perk_vulture_drop_chance" },
    { 0x612F9831, "zombies_perk_vulture_drops_max" },
    { 0x16BCAE6A, "zombies_perk_vulture_max_stink_zombies" },
    { 0x1786213A, "zombies_perk_vulture_network_drops_max" },
    { 0xDB295746, "zombies_perk_vulture_network_time_frame" },
    { 0x34FA67DE, "zombies_perk_vulture_pickup_time" },
    { 0xDDE8D546, "zombies_perk_vulture_pickup_time_stink" },
