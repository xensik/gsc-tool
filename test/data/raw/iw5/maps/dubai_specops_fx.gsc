...
main()
{
	...
	//Global threads
	maps\createfx\so_rooftop_dubai_specops_fx::main();
	setup_shg_fx();
...
treadfx_override()
{
	...
	fx = "treadfx/heli_dust_estate";
	vehicletype_fx[0] = "script_vehicle_mi17_woodland_fly_so";
	vehicletype_fx[1] = "script_vehicle_littlebird_md500";
	vehicletype_fx[2] = "script_vehicle_littlebird_bench";
	foreach(vehicletype in vehicletype_fx)
	{
		maps\_treadfx::setvehiclefx( vehicletype, "brick", fx );
	 	maps\_treadfx::setvehiclefx( vehicletype, "bark", fx );
